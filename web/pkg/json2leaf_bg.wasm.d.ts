...
export const __wbg_trigramindex_free: (a: number, b: number) => void;
export const jsonToDot: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number, number];
